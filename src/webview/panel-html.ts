...
<div id="app">
  <nav id="sidebar">
    <ul class="nav-links">
      ...
      <li><a href="#" data-page="dashboard" class="active"><span class="nav-icon"><svg width="16" height="16" viewBox="0 0 16 16" fill="none"><rect x="1" y="8" width="3" height="6" rx="0.5" fill="currentColor"/><rect x="5.5" y="5" width="3" height="9" rx="0.5" fill="currentColor"/><rect x="10" y="2" width="3" height="12" rx="0.5" fill="currentColor"/></svg></span> Дашборд</a></li>
      <li><a href="#" data-page="timeline"><span class="nav-icon">&#9472;</span> Таймлайн<span class="nav-badge" id="badge-sessions"></span></a></li>
      ...
      <li><a href="#" data-page="config-health"><span class="nav-icon"><svg width="16" height="16" viewBox="0 0 16 16" fill="none"><path d="M8 1L1.5 4.5V11.5L8 15L14.5 11.5V4.5Z" stroke="currentColor" stroke-width="1.3" fill="none"/><path d="M8 5.5V10.5M5.5 8H10.5" stroke="currentColor" stroke-width="1.5" stroke-linecap="round"/></svg></span> Качество контекста</a></li>
      <li><a href="#" data-page="level-up"><span class="nav-icon"><svg width="16" height="16" viewBox="0 0 16 16" fill="none"><path d="M8 1l2 5h5l-4 3.5 1.5 5L8 11.5 3.5 14.5 5 9.5 1 6h5z" stroke="currentColor" stroke-width="1.2" fill="none"/></svg></span> Развитие</a></li>
    </ul>
    <div class="sidebar-filters">
      ...
      <div class="sidebar-filter">
        ...
        <select id="harness-filter"><option value="">Все harness</option></select>
      </div>
    </div>
  </nav>
